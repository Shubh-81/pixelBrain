...
const Home = () => {
  ...
  return (
    <secton className="max-w-7xl mx-auto">
        <div>
        ...
        <div className='mt-16'>
            <FormFeild LabelName="Search Posts" type="text" name="text" placeholder="Search Posts" value={searchText} handleChange={handleSearchChange}/>
        </div>
        <div className='mt-10'>
            ...
            <>
                ...
                <div className='grid lg:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 gap-3'>
                    {searchText ? (<RenderCards data={searchResult} title="No search results found"/>):
